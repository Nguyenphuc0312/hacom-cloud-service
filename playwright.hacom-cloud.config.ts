...
const apiTarget =
  process.env.HACOM_CLOUD_API_BASE_URL ?? "http://127.0.0.1:33001";
const authTarget =
  process.env.HACOM_CLOUD_AUTH_BASE_URL ?? "http://127.0.0.1:3101";
...
export default defineConfig({
  ...
  reporter: [
    ...
    [
      "html",
      {
        outputFolder: "../artifacts/hacom-cloud/browser-report",
        open: "never",
      },
    ],
  ],
  ...
  webServer: {
    ...
    env: {
      ...
      VITE_DEV_WS_PROXY_TARGET:
        process.env.HACOM_CLOUD_WS_BASE_URL ?? "http://127.0.0.1:8001",
