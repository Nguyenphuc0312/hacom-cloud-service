...
type ReportFilters = { from?: string; to?: string; direction?: string; state?: string };

export const DmsReport: React.FC<{ onDrillDown: (group: ReportGroup) => void }> = ({ onDrillDown }) => {
