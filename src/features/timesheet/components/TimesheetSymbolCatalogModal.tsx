...
> = ({ code, onClose }) => {
  ...
  return (
    ...
    >
      {selectedItem ? (
        <section className="border-b border-border bg-surface-overlay/55 px-5 py-3 sm:px-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-[13px] sm:text-right">
        ...
        <div className="border-b border-amber-200 bg-amber-50 px-5 py-3 text-[13px] text-amber-800 sm:px-6">
      ...
      <div className="px-5 pb-5 pt-4 sm:px-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-9 w-full rounded-md border border-border bg-surface pl-9 pr-3 text-[13px] text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary focus:ring-2 focus:ring-primary/15"
          />
        </div>
      </div>
      ...
      {error ? (
        <div className="px-5 pb-4 sm:px-6" role="alert">
          <div className="flex flex-col gap-3 rounded-lg border border-amber-200 bg-amber-50 p-3 text-[13px] text-amber-800 sm:flex-row sm:items-center sm:justify-between">
            <span>
              ...
              {filteredItems.map((item) => {
                ...
                return (
                  <li
                    key={item.id}
                    className={clsx(
                      "grid gap-2 px-5 py-3 text-[13px] md:grid-cols-[7rem_minmax(12rem,1.4fr)_minmax(10rem,1fr)_8rem_minmax(11rem,1fr)] md:items-center md:gap-4 md:px-6 md:py-3",
