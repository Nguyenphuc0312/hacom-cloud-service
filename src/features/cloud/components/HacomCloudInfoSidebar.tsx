...
import { ChevronDown, ChevronRight, File, FileImage, FileText, FolderOpen, Forward, Trash2, Video, X } from "lucide-react";
import type { CloudAsset, CloudQuota } from "../api/cloudApi";

/**
 * Kho lưu trữ (Ảnh/Video · File · Link) dùng ĐÚNG component của panel thông tin nhóm
 * để hai màn cùng một vốn từ — thay vì Cloud tự dựng ba mục dọc riêng.
 */
const SharedResourcesPreview = React.lazy(() =>
