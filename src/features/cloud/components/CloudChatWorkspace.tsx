...
export const PersonalCloudConversationSurface: React.FC = () => {
  ...
  return <section className="flex h-full min-h-0 overflow-hidden bg-surface text-text-primary">
    ...
    <HacomCloudInfoSidebar open={infoOpen} onClose={() => setInfoOpen(false)} quota={space?.quota ?? null} assets={assets} conversationId={conversationId} loading={!space && !error} onChanged={refresh} />
