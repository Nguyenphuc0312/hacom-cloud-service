...
export const queryKeys = {
  ...
  supportIssuesRoot: ['support-issues'] as const,
  supportIssues: (params: QueryParams) => ['support-issues', params] as const,
  supportIssueDetailRoot: ['support-issue-detail'] as const,
  supportIssueDetail: (id: string) => ['support-issue-detail', id] as const,
