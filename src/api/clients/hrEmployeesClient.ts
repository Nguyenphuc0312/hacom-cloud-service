...
export const hrEmployeesClient = {
  ...
  async validateHrImport(payload: ValidateHrImportPayload): Promise<HrImportValidationResult> {
    const response = await axiosInstance.post('/admin/hr-imports/validate', payload);
  ...
  async commitHrImport(
    ...
    const response = await axiosInstance.post(`/admin/hr-imports/${batchId}/commit`, payload);
  ...
  async downloadHrImportReport(batchId: string): Promise<HrImportErrorReport> {
    const response = await axiosInstance.get(`/admin/hr-imports/${batchId}/report`);
  ...
  async provisionHrEmployeeAccount(
    ...
    const response = await axiosInstance.post(`/admin/hr-employees/${id}/provision-account`, payload);
