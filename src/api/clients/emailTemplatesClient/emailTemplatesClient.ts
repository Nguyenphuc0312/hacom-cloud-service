...
import type { EmailTemplateListPayload, EmailTemplatePreviewResponse, EmailTemplateRecord, PreviewEmailTemplateRequest, RollbackEmailTemplateRequest, UpsertEmailTemplateDraftRequest } from '@/api/types/email-templates/email-templates';
