          ...
          {options.map((opt) => (
            <button
              ...
              className={clsx(
                ...
                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1976D2]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-surface",
                value === opt.value
                  ? "border-[#1976D2]/25 bg-[#1976D2]/8 shadow-xs"
            ...
            >
              ...
              <span
                className={clsx(
                  "text-sm font-medium",
                  value === opt.value ? "text-[#1565C0]" : "text-text-primary",
                )}
              >
                {opt.label}
              </span>
        ...
        <div className="space-y-2">
          {options.map((opt) => (
            <button
              ...
              onClick={() => onChange(opt.value)}
              className={clsx(
                "flex w-full items-start gap-3 rounded-xl border px-3 py-3 text-left transition-micro focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1976D2]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-surface",
                value === opt.value
                  ? "border-[#1976D2]/20 bg-[#1976D2]/8"
            ...
            >
              <span
                className={clsx(
                  ...
                  value === opt.value ? "border-[#1565C0]" : "border-border-strong",
                )}
              >
                {value === opt.value ? (
              ...
              {opt.icon ? (
                <span
                  className={clsx(
                    ...
                    value === opt.value
                      ? "border-[#1976D2]/20 bg-[#1976D2]/10 text-[#1565C0]"
