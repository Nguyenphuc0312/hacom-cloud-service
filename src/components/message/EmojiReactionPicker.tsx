    ...
    >
      <div
        className={clsx(
          ...
          "shadow-[0_8px_32px_rgba(0,0,0,0.12),0_2px_8px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.08)]",
          // Animate in
      ...
      >
        {emojisToShow.map((emoji) => (
          <button
            ...
            className={clsx(
              ...
              "hover:scale-125 hover:bg-surface-overlay dark:hover:bg-surface-overlay",
              "active:scale-110",
            )}
          >
            {emoji}
        ...
        <button
          ...
          className={clsx(
            ...
            "bg-surface-overlay text-text-secondary ring-1 ring-border transition-all duration-100 hover:scale-110 hover:bg-surface-hover",
            "dark:bg-surface-overlay dark:text-text-secondary dark:ring-white/10 dark:hover:bg-surface-active",
          )}
        >
          <Plus
            size={14}
