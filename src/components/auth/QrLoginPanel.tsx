  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="relative">
        <div
          className="flex items-center justify-center rounded-2xl border border-border bg-white p-2 shadow-sm"
        ...
        >
          ...
          {(panelState?.status === QrLoginSessionStatus.REJECTED ||
            ...
            <button
              ...
              className="absolute inset-0 flex flex-col items-center justify-center gap-2 rounded-2xl bg-white/90 text-sm font-semibold text-slate-700 transition hover:bg-white"
            >
        ...
        <button
          ...
          className="absolute -right-3 -top-3 flex h-7 w-7 items-center justify-center rounded-full border border-border bg-white shadow-sm text-text-muted transition hover:text-primary disabled:opacity-40"
        >
