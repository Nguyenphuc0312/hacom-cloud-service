...
| 5 | F-06 gộp `asRecord`/`asString` — **19 file** | THẤP | ✅ XONG |
| 6 | Gộp `compareMessages` về một nguồn | THẤP | ✅ XONG — có căn cứ từ `chatStore.ts:552` |
...
**Chốt cuối phiên 23-07-26:** `npm test` **760 pass · 0 fail** · `test:chat-runtime` **118/118** · typecheck sạch · lint file đã đụng sạch · build ✓

`chatStore.ts` **5101 → 4041 dòng (−1060, −21%)** qua 9 lát cắt, mỗi lát có test đặc tả viết TRƯỚC khi gỡ code cũ.
